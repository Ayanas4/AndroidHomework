...
//    private int progressCount;
    ...
    private void initAttrs(Context context, AttributeSet attrs) {
        ...
        sideColor = ta.getColor(R.styleable.SaleProgressView_sideColor, Color.parseColor("#80FB9435"));
        textColor = ta.getColor(R.styleable.SaleProgressView_textColor, Color.parseColor("#FFFFFF"));
    ...
    protected void onSizeChanged(int w, int h, int oldw, int oldh) {
        ...
        //留出一定的间隙，避免边框被切掉一部分
        if (bgRectF == null) {
            bgRectF = new RectF(sideWidth-20, sideWidth, width - 20, height - sideWidth);
        }
...
//        }
    ...
    private void drawBg(Canvas canvas) {
        ...
        if (bgSrc == null) {
            Bitmap bitmap;
            Drawable drawable = ContextCompat.getDrawable(this.getContext(), R.drawable.ic_bar);
    ...
    private void drawFg(Canvas canvas) {
        ...
        if (fgSrc == null) {
            Bitmap bitmap;
            Drawable drawable = ContextCompat.getDrawable(this.getContext(), R.drawable.ic_bar_fg);
            bitmap = Bitmap.createBitmap(drawable.getIntrinsicWidth(), drawable.getIntrinsicHeight(), Bitmap.Config.ARGB_8888);
